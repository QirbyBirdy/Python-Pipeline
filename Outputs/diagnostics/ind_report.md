...
- 1422 near-duplicate value pair(s) found across the free-text columns (Jaro-Winkler >= 0.95) -- see ind_near_duplicates.csv for manual review before building any value-consolidation mapping.
